...
class CourseViewComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.image = Image(page, 'course-preview-image', 'Image preview')
        self.max_score_text = Text(page, 'course-max-score-info-row-view-text', 'Max Score text')
        self.min_score_text = Text(page, 'course-min-score-info-row-view-text', 'Min Score text')
